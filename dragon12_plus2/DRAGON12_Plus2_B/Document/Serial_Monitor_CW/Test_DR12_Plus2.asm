...
TC0ISR: equ     $EB09   ; decided by motor_E800.asm
rtiisr: equ     $EA08   ; decided by motro_E800.asm

        org     $FF8A   ; real vector table
;
	...
	fdb	timer6  ;$FFE2: Standard Timer Channel 6
	fdb	timer5_spk	;$FFE4: Standard Timer Channel 5
	...
	fdb	TC0ISR  ;$FFEE: Standard Timer Channel 0 for motor test
	fdb	rtiisr	;$FFF0: Real Time Interrupt (RTI)
